...
public void draw() 
{
  ...
  int yyy = arduino.analogRead (5)/50;
  //apple
  fill (250,88,88);
  ellipse(60,35,35 + yyy,30 + yyy);
  line(60,22,60,0);
  arc (61,22,8,8,PI/10,PI);
  
  int yy = arduino.analogRead(5)/50;
  //tail
  line(315,215,343,267 - yy);
  //left tail branch
  line(337,258 - yy,336,268 - yy);
  //right tail branch
  line(337,256 - yy,347,262 - yy);
 
  int y = arduino.analogRead(5)/10;
  stroke(0,0,0);
  //head
  fill(255,255,158);
  triangle(160,53 - y,169,81 - y,113,102 - y);
  //neck
  triangle(169,81-y,225,215, 185, 215);
  //body
  rect(185, 215, 130, 90);
  //1st leg
  triangle(185,305,205,305,195,415);
  ...
  stroke(0,0,0);
  //left antler
  line(160,55 - y,150,31 - y);
  //right antler
  line(160,55 - y,171,31 - y);
  
  //eye
  stroke(0,0,0);
  fill(0,0,0);
  ellipse(153,72 - y,6,6);
